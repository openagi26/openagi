 ...
 * Ported from OpenAGI's message-extract.ts to handle the various
...
function cleanUserText(text: string): string {
  return text
    // 【Bug1 修复】剥离 [系统指令]...[/系统指令] 标签，防止系统提示词泄露给用户
...
export function formatTimestamp(timestamp: unknown): string {
  ...
  // OpenAGI timestamps can be in seconds or milliseconds
