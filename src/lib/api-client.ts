...
const GATEWAY_WS_DIAG_FLAG = 'openagi:gateway-ws-diagnostic';
...
function shouldLogApiRequests(): boolean {
  try {
    return import.meta.env.DEV || window.localStorage.getItem('openagi:api-log') === '1';
  } catch {
