...
import zhTrinity from './locales/zh/trinity.json';
...
import jaTrinity from './locales/ja/trinity.json';
...
i18n
    ...
    .init({
        ...
        defaultNS: 'common',
        ns: ['common', 'settings', 'dashboard', 'chat', 'channels', 'agents', 'skills', 'cron', 'setup', 'trinity'],
        interpolation: {
