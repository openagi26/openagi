...
export function TitleBar() {
  ...
  if (platform === 'darwin') {
    // macOS: 玻璃态拖拽区域，红绿灯原生渲染
    return <div className="drag-region glass-titlebar h-10 shrink-0" />;
  }
...
function WindowsTitleBar() {
  ...
  return (
    <div className="drag-region glass-titlebar flex h-10 shrink-0 items-center justify-end">
