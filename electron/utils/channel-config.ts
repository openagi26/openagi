...
export async function readOpenClawConfig(): Promise<OpenClawConfig> {
    ...
    try {
        ...
        logger.error('Failed to read OpenAGI config', error);
        console.error('Failed to read OpenAGI config:', error);
        return {};
    }
}
...
export async function writeOpenClawConfig(config: OpenClawConfig): Promise<void> {
    ...
    try {
        ...
        logger.error('Failed to write OpenAGI config', error);
        console.error('Failed to write OpenAGI config:', error);
        throw error;
    }
}
