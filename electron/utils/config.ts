 ...
 */
export const PORTS = {
  /** OpenAGI GUI development server port */
  OPENAGI_DEV: 5173,
  
  /** OpenAGI GUI production port (for reference) */
  OPENAGI_GUI: 23333,

  /** Local host API server port */
  OPENAGI_HOST_API: 13220,
...
export function getPort(key: keyof typeof PORTS): number {
  const envKey = `OPENAGI_PORT_${key}`;
...
export const APP_PATHS = {
  ...
  /** OpenAGI configuration directory */
  OPENAGI_CONFIG: '~/.openagi',
