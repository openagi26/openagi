      ...
      submenu: [
        {
          label: 'Documentation',
          click: async () => {
            await shell.openExternal('https://openagi.app');
          },
        },
        {
          label: 'Report Issue',
          click: async () => {
            await shell.openExternal('https://github.com/openagi-ai/OpenAGI/issues');
          },
        },
        { type: 'separator' },
        {
          label: 'OpenAGI Documentation',
          click: async () => {
            await shell.openExternal('https://docs.openagi.ai');
          },
        },
      ],
    },
